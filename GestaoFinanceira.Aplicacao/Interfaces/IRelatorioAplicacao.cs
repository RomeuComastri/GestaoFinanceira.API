...
public interface IRelatorioAplicacao
{
    Task<SaldoToTalTransacoes> ObterSaldoTotalAsync(int usuarioId, DateTime? dataInicio = null, DateTime? dataFim = null, int? categoriaId = null, string tipo = null);
